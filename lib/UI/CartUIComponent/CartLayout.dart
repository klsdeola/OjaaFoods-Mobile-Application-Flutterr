...
import 'package:oa/ListItem/CartItemData.dart';
import 'package:oa/UI/CartUIComponent/Delivery.dart';
...
class _cartState extends State<cart> {
  ...
  Widget build(BuildContext context) {
      return Scaffold(
          appBar: AppBar(
            iconTheme: IconThemeData(color: Color(0xFFE57C00)),
            centerTitle: true,
                ...
                actions: <Widget>[
                  new IconSlideAction(
                    ...
                    onTap: () {
                      ...
                      ///
                      Scaffold.of(context)
                          .showSnackBar(SnackBar(content: Text("Items Cart Archive"),duration: Duration(seconds: 2),backgroundColor: Color(0xFFE57C00),));
                    },
                  ),
                ],
