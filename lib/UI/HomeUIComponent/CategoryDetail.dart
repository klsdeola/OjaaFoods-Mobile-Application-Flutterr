...
import 'package:oa/ListItem/CategoryItem.dart';
import 'package:oa/ListItem/CategoryItem.dart';
import 'package:oa/ListItem/CategoryItem.dart';
import 'package:oa/UI/HomeUIComponent/PromotionDetail.dart';
import 'package:oa/UI/HomeUIComponent/Search.dart';
    ...
    var _imageSlider = Padding(
      ...
      child: Container(
        ...
        child: new Carousel(
          ...
          images: [
            AssetImage("assets/imgPromo/pr1.jpg"),
            AssetImage("assets/imgPromo/pr2.png"),
            AssetImage("assets/imgPromo/p3.jpg"),
            AssetImage("assets/imgPromo/pr4.jpg"),
          ],
        ),
      ),
    );
      ...
      appBar: AppBar(
        actions: <Widget>[
          IconButton(
            ...
            icon: Icon(Icons.search, color: Color(0xFFE57C00)),
          ),
        ],
        centerTitle: true,
        title: Text(
